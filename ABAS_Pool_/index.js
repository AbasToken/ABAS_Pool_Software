...
var INFURA_ROPSTEN_URL = 'https://arb-mainnet.g.alchemy.com/v2/WHa04zxQ0-gU4lKeWM0Se47WOG8RZpg3';
var INFURA_MAINNET_URL = 'https://arb-mainnet.g.alchemy.com/v2/WHa04zxQ0-gU4lKeWM0Se47WOG8RZpg3';
...
async function init(web3)
{
      ...
      // Code to run if we're in a worker process
        ...
        var worker_id = cluster.worker.id
              ...
              await redisInterface.init()
              await tokenInterface.init(redisInterface,web3,accountConfig,poolConfig,pool_env)
              peerInterface.listenForJSONRPC(16129);
              tokenInterface.update();
              peerInterface.update();
      }
}
