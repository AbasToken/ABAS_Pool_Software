     ...
     for(i in solution_txes)
     {
       try{
		...
		try{
			...
			console.log("TOPICS: ", fuk[0].topics)
			
			console.log("TOPICS include: ", fuk[0].topics[0])
			console.log("TOPICS include check: ", fuk[0].topics[0] == "0xcf6fbb9dcea7d07263ab4f5c3a92f53af33dffc421d9d121e1c74b307e68189d")
			for(var x=0; x<5; x++){
				if(fuk[x].topics[0] == "0xcf6fbb9dcea7d07263ab4f5c3a92f53af33dffc421d9d121e1c74b307e68189d"){
					position = fuk[x].data
					break
				}
			}
