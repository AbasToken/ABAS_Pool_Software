...
module.exports =  {
  ...
  async init( https_enabled,webInterface,peerInterface   )
  {
    ...
    //  app.get('/', (req, res) => res.send('Hello World!'))
      ...
      app.listen(13000, () => console.log('Web app listening on port 13000!'))
      app.listen(11181, () => console.log('Web app listening on port 11181!'))
  ...
  startSocketServer(server )
  {
    ...
    var port = process.env.PORT || 12095;
