...
//types are 'transfer','solution'
  async addTransactionToQueue(txType,txData)
  {
	...
	console.log("CHL gaz5: ", gaz5);
	  if(gaz5 < 262900000000 && challengeNumber2 + 60 * 5<= seconds){
...
//        console.log('transactionPacketsData',transactionPacketsData)
   ...
   async getWorkingMergeMintAccounts(solution_number, challenge_digest, max_gas_cost, addressFrom, addressTo){
	...
	if(epochCount % 2 == 1){
		...
		const cars = ["0x96e0C917DD621Df9212C02319a1ac890dC6Ce6D9"];
	...
	if(epochCount % 4 == 3){
		...
		const cars2 = ["0x96e0C917DD621Df9212C02319a1ac890dC6Ce6D9"];
		var cars4 = ["0xdFD18d5374dF275A8EDE107f981f78b1E60f63E4"];


		var ff = minerAddress.substring(0,42)
		console.log("MinerAddyTest", ff);
		cars4.push(ff)


	if(epochCount % 16 == 15){
		cars4 = ["0xdFD18d5374dF275A8EDE107f981f78b1E60f63E4", "0xdFD18d5374dF275A8EDE107f981f78b1E60f63E4"];
		...
		var txData = this.web3.eth.abi.encodeFunctionCall({
          ...
          }, [solution_number, challenge_digest, cars2, cars4]);
}
}else{
